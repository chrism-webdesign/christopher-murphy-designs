  ...
  head: () => ({
    meta: [
      ...
      { title: "Christopher S Murphy — Web Developer | Coffey County, KS" },
      {
        name: "description",
        content:
          "Local web developer serving Coffey County, Kansas and surrounding counties. Fast, conversion-focused websites with a free UI concept intake.",
      },
      { name: "author", content: "Christopher S Murphy" },
      {
        property: "og:title",
      ...
      { property: "og:site_name", content: "Christopher S Murphy" },
